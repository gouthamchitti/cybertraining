...
export default function VizagPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-850 dark:to-gray-800">
      <JsonLd type="localBusiness" location="Vizag" />
      {/* Header/Navigation */}
      <NavBar />
              ...
              <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
                <div className="sm:text-center lg:text-left lg:col-span-6">
                  <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl mb-6 animate-fade-in-up">
                    ...
                    <span className="block text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">Training in Vizag</span>
                  </h1>
                  <div className="mt-6 animate-fade-in-up animation-delay-100">
                    <p className="text-lg md:text-xl leading-7 md:leading-8 text-gray-300 max-w-3xl">
                      Join Visakhapatnam's premier cybersecurity training program led by <span className="text-indigo-400 font-semibold">Goutham Kumar</span>, an industry expert with 8+ years of experience. Master ethical hacking, penetration testing, and network security with hands-on training.
                    </p>
                  </div>
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                              <div className="relative w-48 h-48 md:w-64 md:h-64 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-full flex items-center justify-center shadow-lg shadow-indigo-500/50 dark:shadow-indigo-700/50 overflow-hidden border-4 border-indigo-400/50">
                                <Image
                                  ...
                                  alt="Goutham Kumar - Cybersecurity Expert in Vizag"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white sm:text-4xl">
                ...
                <span className="block text-indigo-600 dark:text-indigo-400">Visakhapatnam (Vizag)</span>
              </h2>
              <p className="mt-4 max-w-2xl text-xl text-gray-500 dark:text-gray-300 mx-auto">
                Comprehensive cybersecurity training tailored for professionals and students in Vizag
              </p>
            </div>
            ...
            <div className="mt-10">
              <div className="prose prose-indigo dark:prose-invert max-w-none">
                <p>
                  Our cybersecurity training program in Visakhapatnam (Vizag) is designed to provide hands-on experience with real-world scenarios. Located in the heart of Vizag, our training center offers a convenient location for professionals and students looking to enhance their cybersecurity skills.
                </p>

                <h3>Why Choose Our Cybersecurity Training in Vizag?</h3>
                ...
                <h3>Popular Courses in Vizag</h3>
                ...
                <p>
                  Join the growing cybersecurity community in Vizag and take your career to the next level. Our training programs are designed to help you build practical skills that are in high demand in today's job market.
                </p>
                ...
                <div className="mt-8 flex justify-center">
                  ...
                  >
                    Contact Us for Training in Vizag
                  </Link>
                </div>
              </div>
            </div>
